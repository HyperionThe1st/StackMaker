...
public class PlayerAction : Player
{
    ...
    public bool IsCheering => player.CurrentState == PlayerState.Cheer;
    ...
    public void Idle()
    {
        if (player.CurrentState == PlayerState.Cheer)
        {
            return;
        }
    ...
    public void Cheer()
    {
        player.ChangeState(PlayerState.Cheer);
    }
    ...
    {
        player.PlayerMovement.MovingDirection = CardinalDirection.Standby;
